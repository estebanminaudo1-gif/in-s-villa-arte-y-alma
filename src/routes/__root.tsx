...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Inés Villa — Artista plástica de Escobar" },
      { property: "og:description", content: "Arte que retrata emociones, naturaleza y espiritualidad." },
